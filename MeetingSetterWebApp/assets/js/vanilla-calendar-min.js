...
let VanillaCalendar = (function () {
  return function (t) {
    ...
    const d = function (t) {
      ...
      e.setAttribute("data-calendar-date-ms", t.getTime())
        ...
        l.querySelectorAll("[data-calendar-status=active]").forEach(t => {
          t.addEventListener("click", function () {
            if (this.classList.contains("vanilla-calendar-date--selected")) {
              ...
              //console.log(this.getAttribute("data-calendar-date-ms"));
            }
          });
        });
      },
    ...
    (this.init = function () {
      ...
      (this.getDates = function () {
        ...
        document
          ...
          .forEach(t => {
            selectedDates.push(t.getAttribute("data-calendar-date-ms"));
          });
